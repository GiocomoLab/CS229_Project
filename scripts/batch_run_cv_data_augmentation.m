...
function results = batch_run_cv_data_augmentation(Xtrain,Ytrain,Xtest,YTest,numOrigFeats,feats,fold_inds,modelTypes,hyperParams)
...
for i = 1:length(modelTypes)
    ...
    [Y_train,Y_test,Y_hat_train,Y_hat_test,theta] = run_cv(Xtrain,Ytrain,Xtest,...
        Ytest,numOrigFeats,fold_inds,...   
